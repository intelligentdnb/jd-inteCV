                        ...
                        <div className="col-md-8">
                            ...
                            <div className="card text-white bg-primary mb-3">
                                <div className="card-body">
                                    ...
                                    <p className="card-text"><a href="https://www.linkedin.com/in/juandimca" target="_blank" style={{ color: "white", }}>linkedin.com/in/juandimca</a> &nbsp; <a href="https://github.com/intelligentdnb" target="_blank" style={{ color: "white", }}>github.com/intelligentdnb</a></p>
